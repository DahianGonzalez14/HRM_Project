...
namespace ProyectoFinalASP.Controllers
{
    public class LicenciasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,FK_Empleado,Desde,Hasta,Motivo,Comentario")] Licencias licencias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,FK_Empleado,Desde,Hasta,Motivo,Comentario")] Licencias licencias)
        {
            if (ModelState.IsValid)
            {
