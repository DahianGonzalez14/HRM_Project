...
namespace ProyectoFinalASP.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Codigo_Empleado,Nombre,Apellido,Departamento,Telefono,Cargo,Salario,Fecha_DE_Ingreso,Estatus")] Empleados empleados)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Codigo_Empleado,Nombre,Apellido,Departamento,Telefono,Cargo,Salario,Fecha_DE_Ingreso,Estatus")] Empleados empleados)
        {
            if (ModelState.IsValid)
            {
